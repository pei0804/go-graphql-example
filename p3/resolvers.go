...
// GetAccount resolves the getAccount query
func (r *Resolver) GetAccount(ctx context.Context, args struct{ ID int32 }) (*Account, error) {
	return db.getAccount(ctx, int32(args.ID))
}
